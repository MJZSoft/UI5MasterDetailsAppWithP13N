sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("mjzsoft/sapui5/tutorial/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("mjzsoft.sapui5.tutorial.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["mjzsoft/sapui5/tutorial/localService/mockserver"], function (mockserver) {
